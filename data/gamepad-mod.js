...
(function (root, factory) {
    ...
    var gamepadSupport = {
        ...
        onGamepadConnect: function(ev) {
            ...
            // Dispatch update event to show more gamepads.
            gamepadSupport.dispatchUpdate(gamepadSupport.gamepads);
        ...
        onGamepadDisconnect: function(ev) {
            ...
            // Dispatch update event to remove the gamepad.
            gamepadSupport.dispatchUpdate(gamepadSupport.gamepads)
        },
        ...
        pollStatus: function() {
            ...
            for (var i in gamepadSupport.gamepads) {
                ...
                //todo: update individual gamepad event
                gamepadSupport.dispatchUpdate(gamepadSupport.gamepads);
            }
        },
